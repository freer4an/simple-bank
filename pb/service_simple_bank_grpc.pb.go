...
const (
	...
	SimpleBank_RenewAcces_FullMethodName = "/pb.SimpleBank/RenewAcces"
)
...
type SimpleBankClient interface {
	...
	RenewAcces(ctx context.Context, in *RefreshTokenReq, opts ...grpc.CallOption) (*RefreshTokenRsp, error)
}
...
func (c *simpleBankClient) RenewAcces(ctx context.Context, in *RefreshTokenReq, opts ...grpc.CallOption) (*RefreshTokenRsp, error) {
	out := new(RefreshTokenRsp)
	err := c.cc.Invoke(ctx, SimpleBank_RenewAcces_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SimpleBankServer interface {
	...
	RenewAcces(context.Context, *RefreshTokenReq) (*RefreshTokenRsp, error)
...
func (UnimplementedSimpleBankServer) RenewAcces(context.Context, *RefreshTokenReq) (*RefreshTokenRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RenewAcces not implemented")
}
...
func _SimpleBank_RenewAcces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefreshTokenReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleBankServer).RenewAcces(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SimpleBank_RenewAcces_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).RenewAcces(ctx, req.(*RefreshTokenReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RenewAcces",
			Handler:    _SimpleBank_RenewAcces_Handler,
		},
	},
